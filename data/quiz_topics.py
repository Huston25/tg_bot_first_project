...
QUIZ_TOPICS = {
    "potter": {
        "name": "🔮 Гарри Поттер",
        "emoji": "🔮",
        "prompt": """Ты создаешь вопросы для квиза на тему Гарри Поттера. 
...
Правильный ответ: [буква]"""
    ...
    "ring": {
        "name": "⭕ Вселенная 'Властелина колец'",
        "emoji": "⭕",
        "prompt": """Ты создаешь вопросы для квиза по вселенной Властелина колец.
